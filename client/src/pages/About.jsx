export default function About() {
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      ...
      <h1 className="text-3xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-4 text-slate-800">
        About NKusi Estate
      </h1>
      <p className="text-sm md:text-base lg:text-lg xl:text-xl mb-4 text-slate-700">
        Nkusi Estate is a leading real estate agency that specializes in helping
        clients buy, sell, and rent properties in the most desirable
        neighborhoods. Our team of experienced agents is dedicated to providing
        exceptional services and making the buying and selling process as smooth
        as possible.
      </p>
      <p className="text-sm md:text-base lg:text-lg xl:text-xl mb-4 text-slate-700">
